...
class StateDictType(enum.Enum):
    ...
    KOHYA_SS = "kohya_ss"
    PEFT = "peft"
    PEFT_EIGENLORA = "peft_eigenlora"
    DIFFUSERS = "diffusers"
    DIFFUSERS_EIGENLORA = "diffusers_eigenlora"
...
UNET_TO_DIFFUSERS_eigenlora = {
    ".to_out_eigenlora.up": ".to_out.0.eigenlora_B",
    ".to_out_eigenlora.down": ".to_out.0.eigenlora_A",
    ".to_q_eigenlora.down": ".to_q.eigenlora_A",
    ".to_q_eigenlora.up": ".to_q.eigenlora_B",
    ".to_k_eigenlora.down": ".to_k.eigenlora_A",
    ".to_k_eigenlora.up": ".to_k.eigenlora_B",
    ".to_v_eigenlora.down": ".to_v.eigenlora_A",
    ".to_v_eigenlora.up": ".to_v.eigenlora_B",
    ".eigenlora.up": ".eigenlora_B",
    ".eigenlora.down": ".eigenlora_A",
}
...
PEFT_TO_DIFFUSERS_eigenlora = {
    ".q_proj.eigenlora_B.loadings": ".q_proj.eigenlora_linear_layer.up.loadings",
    ".q_proj.eigenlora_B.components": ".q_proj.eigenlora_linear_layer.up.components",
    ".q_proj.eigenlora_A.loadings": ".q_proj.eigenlora_linear_layer.down.loadings",
    ".q_proj.eigenlora_A.components": ".q_proj.eigenlora_linear_layer.down.components",
    ".k_proj.eigenlora_B.loadings": ".k_proj.eigenlora_linear_layer.up.loadings",
    ".k_proj.eigenlora_B.components": ".k_proj.eigenlora_linear_layer.up.components",
    ".k_proj.eigenlora_A.loadings": ".k_proj.eigenlora_linear_layer.down.loadings",
    ".k_proj.eigenlora_A.components": ".k_proj.eigenlora_linear_layer.down.components",
    ".v_proj.eigenlora_B.loadings": ".v_proj.eigenlora_linear_layer.up.loadings",
    ".v_proj.eigenlora_B.components": ".v_proj.eigenlora_linear_layer.up.components",
    ".v_proj.eigenlora_A.loadings": ".v_proj.eigenlora_linear_layer.down.loadings",
    ".v_proj.eigenlora_A.components": ".v_proj.eigenlora_linear_layer.down.components",
    ".out_proj.eigenlora_B.loadings": ".out_proj.eigenlora_linear_layer.up.loadings",
    ".out_proj.eigenlora_B.components": ".out_proj.eigenlora_linear_layer.up.components",
    ".out_proj.eigenlora_A.loadings": ".out_proj.eigenlora_linear_layer.down.loadings",
    ".out_proj.eigenlora_A.components": ".out_proj.eigenlora_linear_layer.down.components",
    "to_k.eigenlora_A.loadings": "to_k.eigenlora.down.loadings",
    "to_k.eigenlora_A.components": "to_k.eigenlora.down.components",
    "to_k.eigenlora_B.loadings": "to_k.eigenlora.up.loadings",
    "to_k.eigenlora_B.components": "to_k.eigenlora.up.components",
    "to_q.eigenlora_A.loadings": "to_q.eigenlora.down.loadings",
    "to_q.eigenlora_A.components": "to_q.eigenlora.down.components",
    "to_q.eigenlora_B.loadings": "to_q.eigenlora.up.loadings",
    "to_q.eigenlora_B.components": "to_q.eigenlora.up.components",
    "to_v.eigenlora_A.loadings": "to_v.eigenlora.down.loadings",
    "to_v.eigenlora_A.components": "to_v.eigenlora.down.components",
    "to_v.eigenlora_B.loadings": "to_v.eigenlora.up.loadings",
    "to_v.eigenlora_B.components": "to_v.eigenlora.up.components",
    "to_out.0.eigenlora_A.loadings": "to_out.0.eigenlora.down.loadings",
    "to_out.0.eigenlora_A.components": "to_out.0.eigenlora.down.components",
    "to_out.0.eigenlora_B.loadings": "to_out.0.eigenlora.up.loadings",
    "to_out.0.eigenlora_B.components": "to_out.0.eigenlora.up.components",
}
...
def convert_unet_state_dict_to_peft(state_dict, use_eigenlora):
    r"""
    Converts a state dict from UNet format to diffusers format - i.e. by removing some keys
    """
    if use_eigenlora:
        mapping = UNET_TO_DIFFUSERS_eigenlora
    else:
