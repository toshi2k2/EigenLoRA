...
PEFT_TYPE_TO_MODEL_MAPPING = {
    ...
    PeftType.EIGENLORA: EigenLoRAModel,
}
...
class PeftModel(PushToHubMixin, torch.nn.Module):
    ...
    **Attributes**:
    ...
    def save_pretrained(
        ...
        save_eigenlora_loadings:bool = True,
        save_eigenlora_components:bool = False,
        **kwargs: Any,
    ) -> None:
        r"""
        ...
        for adapter_name in selected_adapters:
            ...
            output_state_dict = get_peft_model_state_dict(
                ...
                save_eigenlora_loadings=save_eigenlora_loadings,
                save_eigenlora_components = save_eigenlora_components
            )
